...
//lastnames
const lastNameFind = users.map(user => user.lastName);
// membership
const premiumMembers = users.filter(user => user.isPremiumMember === true);
//logged in more than 10times
const timedLogins = users.filter(user => user.logins > 10).map(user => `${user.firstName} ${user.lastName}`);
//total add of logins
...
//last names
console.log(lastNameFind);
//premiumMembers
console.log(premiumMembers);
//logins
console.log(timedLogins);
// totalLogins
